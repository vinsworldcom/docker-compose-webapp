...
`docker service scale myapp_app=2`
...
m69zrbz3bbzx myapp_app   replicated 2/2      app_myapp:latest   
p8lc1l6oszjy myapp_nginx replicated 1/1      nginx_myapp:latest *:8080->80/tcp
uob8mlz006tz myapp_redis replicated 1/1      redis:alpine
```
